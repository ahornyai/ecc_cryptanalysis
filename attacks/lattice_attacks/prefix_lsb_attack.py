...
def prefix_lsb_attack(signatures, pubkey, curve: EllipticCurve, generator, bias_size: int):
    order = curve.order()

    # One signature is used as offset (so we can get rid of the unknown most significant bits of the nonce)
